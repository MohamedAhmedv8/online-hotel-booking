...
@section('title-content','View Rooms')
@section('right_top_button')
<a href="{{ route('admin_room_create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
@endsection
@section('body')
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="example1">
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ asset('storage/'.$room->featured_photo) }}" alt="" class="w_200"></td>
                                    <td>{{ $room->name }}</td>
                                    <td>{{ $room->price }}</td>
                                    <td class="pt_10 pb_10">
                                        <button class="btn btn-warning" data-toggle="modal" data-target="#exampleModal{{ $i }}">Detail</button>
                                        <a href="{{ route('admin_room_gallery',$room->id) }}" class="btn btn-success">Gallery</a>
                                        <a href="{{ route('admin_room_edit',$room->id) }}" class="btn btn-primary">Edit</a>
                                        <a href="{{ route('admin_room_delete',$room->id) }}" class="btn btn-danger" onClick="return confirm('Are you sure?');">Delete</a></td>
                                </tr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group row bdb1 pt_10 mb_0">
                                                    ...
                                                    <div class="col-md-8">
                                                        <img src="{{ asset('storage/'.$room->featured_photo) }}" alt="" class="w_200">
                                                    </div>
                                                </div>
                                                <div class="form-group row bdb1 pt_10 mb_0">
                                                ...
                                                <div class="form-group row bdb1 pt_10 mb_0">
                                                    <div class="col-md-4"><label class="form-label">Price \ Night</label></div>

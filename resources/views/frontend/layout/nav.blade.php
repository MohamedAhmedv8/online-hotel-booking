        <div class="navbar-area" id="stickymenu">
            ...
            <div class="mobile-nav">
                <a href="{{ route('home') }}" class="logo">
                    <img src="{{ asset('storage/'.$global_setting_data->logo) }}" alt="">
                </a>
            </div>
                            ...
                            <ul class="navbar-nav ml-auto">        
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        @foreach ($global_room_data as $room_data)
                                            
                                        <li class="nav-item">
                                            <a href="{{ route('room_details',$room_data->id) }}" class="nav-link">{{ $room_data->name }}</a>
                                        </li>
                                        @endforeach
